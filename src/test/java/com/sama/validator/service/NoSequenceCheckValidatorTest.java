...
@ContextConfiguration(locations = {"classpath:nosequence-check-validator.xml"})
public class NoSequenceCheckValidatorTest extends TestCase {
    @Autowired
